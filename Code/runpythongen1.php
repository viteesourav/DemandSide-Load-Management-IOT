	...
	<div class="boxbox1">
		...
		<form action="adduserloadtodb.php" method="post">
			<div class="row">
				<div class="col-md-10 formleft">
					<label><font size="4">Critical Loads Priority 1: </font><font color="red" size="2">(Range: 0 W to <?php echo round($loaddisplay*0.1); ?>W)</font></label>
					<input type="number" name="l1" id="l1" min="0" max="<?php echo round($loaddisplay*0.1); ?>" value="<?php echo round($loaddisplay*0.05); ?>" class="form-control" required placeholder="Enter L1" onblur="update()">
					<table class="table-content">
						<thead>
							<tr>
						...
						?>
							<tr>
						        <td align="center"><input type="checkbox" name="checked_id[]" class="checkbox" value="<?php echo $row['id']; ?>" checked></td>        
						        <td><?php echo $row['Appliance']; ?></td>
						        <td><input type="number" name="num[]" value="0" onblur="check1()" min="0" max="<?php echo $row['Num']; ?>"></td>
						        <td><input type="number" name="rat[]" min="<?php echo $row['Rating']; ?>" max="<?php echo $row['Rating']; ?>"  value="<?php echo $row['Rating']; ?>"></td>
						    </tr>
						    <?php } }else{ ?>
						...
						<br>
						<div class="col-md-10 formleft">
					<label><font size="4">Light Loads Priority 2: </font><font color="red" size="2">(Range: 0 W to <?php echo round($loaddisplay*0.15); ?>W)</font></label>
						<input type="number" name="l2" id="l2" min="0" max="<?php echo round($loaddisplay*0.15); ?>" value="<?php echo round($loaddisplay*0.1); ?>" class="form-control" required placeholder="Enter L2" onblur="update()">
						<table class="table-content">
							<thead>
								<tr>
									<th><input type="checkbox" id="select_all" class="select_all" value="" checked></th>        
			...
			<div class="row">
				<div class="col-md-10 formleft">
					<label><font size="4">Medium Loads Priority 3: </font><font color="red" size="2">(Range: 0 W to <?php echo round($loaddisplay*0.2); ?>W)</font></label>
						<input type="number" name="m1" id="m1" min="0" max="<?php echo round($loaddisplay*0.2); ?>" value="<?php echo round($loaddisplay*0.15); ?>" class="form-control" required placeholder="Enter M1"
						onblur="update()">
						<table class="table-content">
							<thead>
								<tr>
				...
				<br>
				<div class="col-md-10 formleft">
					<label><font size="4">Medium Loads Priority 4: </font><font color="red" size="2">(Range: 0 W to <?php echo round($loaddisplay*0.25); ?>W)</font></label>
						<input type="number" name="m2" id="m2" min="0" max="<?php echo round($loaddisplay*0.25); ?>" value="<?php echo round($loaddisplay*0.2); ?>" class="form-control" required placeholder="Enter M2" 
						onblur="update()">
						<table class="table-content">
							<thead>
								<tr>
			...
			<div class="row">
				<div class="col-md-10 formleft">
					<label><font size="4">High Loads Priority 5: </font><font color="red" size="2">(Range: 0 W to <?php echo round($loaddisplay*0.3); ?>W)</font></label>
						<input type="number" name="h1" id="h1" min="0" max="<?php echo round($loaddisplay*0.3); ?>" value="<?php echo round($loaddisplay*0.25); ?>" class="form-control" required placeholder="Enter H1" 
						onblur="update()">
						<table class="table-content">
							<thead>
								<tr>
				...
				<br>
				<div class="col-md-10 formleft">
					<label><font size="4">High Loads Priority 6: </font><font color="red" size="2">(Range: 0 W to <?php echo round($loaddisplay*0.3); ?>W)</font></label>
						<input type="number" name="h2" id="h2" min="0" max="<?php echo round($loaddisplay*0.3); ?>" value="<?php echo round($loaddisplay*0.25); ?>" class="form-control" required placeholder="Enter H2" 
						onblur="update()">
						<table class="table-content">
							<thead>
								<tr>
       ...
       function alertme(){
        ...
        <script>
        	function check1()
        	{
	       		var arr1=$("input[name='checked_id[]']").map(function(){return $(this).val();}).get();
	       		var arr2=$("input[name='num[]']").map(function(){return $(this).val();}).get();
	       		var arr3=$("input[name='rat[]']").map(function(){return $(this).val();}).get();
	       		var i;
	       		var sum=0;
	       		...
	       		document.getElementById("l1").value=sum;
	        }
	        ...
	        function check2()
        	{
	       		...
	       		document.getElementById("l2").value=sum;
	        }
	        ...
	        function check3()
        	{
	       		...
	       		document.getElementById("m1").value=sum;
	        }
	        ...
	        function check4()
        	{
	       		...
	       		document.getElementById("m2").value=sum;
	        }
